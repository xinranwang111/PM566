...
```{r}
kable(table(df$term), align = "c", caption = "Number of abstracts associated with each search term")
```
...
[Crystic fibrosis search term shows a positive mean AFINN score, while other search terms have negative mean AFINN score.]{style="color:blue"}
